<h1><a name="http_detection">World http-detection</a></h1>
<ul>
<li>Imports:
<ul>
...
<h2><a name="bulwark:plugin_http_handlers_0.5.0">Export interface bulwark:plugin/http-handlers@0.5.0</a></h2>
<hr />
<h3>Types</h3>
...
[`incoming-response`](#incoming_response)
<p>
#### <a name="handler_output">`type handler-output`</a>
[`handler-output`](#handler_output)
<p>
#### <a name="decision">`type decision`</a>
[`decision`](#decision)
<p>
#### <a name="outcome">`type outcome`</a>
[`outcome`](#outcome)
<p>
#### <a name="param">`type param`</a>
[`param`](#param)
<p>
#### <a name="verdict">`type verdict`</a>
[`verdict`](#verdict)
<p>
...
<h5>Variant Cases</h5>
<ul>
<li><a name="error.other"><code>other</code></a>: <code>string</code><p>Some implementation-specific error has occurred.
</li>
</ul>
<hr />
<h3>Functions</h3>
<h4><a name="handle_init"><code>handle-init: func</code></a></h4>
<p>Called once when the plugin is first instantiated.</p>
<h5>Return values</h5>
<ul>
<li><a name="handle_init.0"></a> result&lt;_, <a href="#error"><a href="#error"><code>error</code></a></a>&gt;</li>
</ul>
<h4><a name="handle_request_enrichment"><code>handle-request-enrichment: func</code></a></h4>
<p>Called on every request.</p>
<p>Plugins should use this handler to perform request enrichment
...
merge these. Copying may create conflict resolution issues.</p>
<p>This is the first handler to execute in response to a request and
any params it emits are guaranteed to be available to all other
plugins prior to their decision handlers being called.</p>
<h5>Params</h5>
<ul>
<li><a name="handle_request_enrichment.request"><code>request</code></a>: own&lt;<a href="#incoming_request"><a href="#incoming_request"><code>incoming-request</code></a></a>&gt;</li>
<li><a name="handle_request_enrichment.params"><code>params</code></a>: list&lt;<a href="#param"><a href="#param"><code>param</code></a></a>&gt;</li>
</ul>
<h5>Return values</h5>
<ul>
<li><a name="handle_request_enrichment.0"></a> result&lt;list&lt;<a href="#param"><a href="#param"><code>param</code></a></a>&gt;, <a href="#error"><a href="#error"><code>error</code></a></a>&gt;</li>
</ul>
<h4><a name="handle_request_decision"><code>handle-request-decision: func</code></a></h4>
<p>Generates the initial verdict by the plugin, prior to sending the request to the interior service.</p>
<p>Most plugin decision logic should take place in this handler.</p>
<h5>Params</h5>
<ul>
<li><a name="handle_request_decision.request"><code>request</code></a>: own&lt;<a href="#incoming_request"><a href="#incoming_request"><code>incoming-request</code></a></a>&gt;</li>
<li><a name="handle_request_decision.params"><code>params</code></a>: list&lt;<a href="#param"><a href="#param"><code>param</code></a></a>&gt;</li>
</ul>
<h5>Return values</h5>
<ul>
<li><a name="handle_request_decision.0"></a> result&lt;<a href="#handler_output"><a href="#handler_output"><code>handler-output</code></a></a>, <a href="#error"><a href="#error"><code>error</code></a></a>&gt;</li>
</ul>
<h4><a name="handle_response_decision"><code>handle-response-decision: func</code></a></h4>
<p>Generates a secondary verdict after the interior service has sent back its response.</p>
<p>Plugins that need to inspect responses, particularly response
...
a decision by the plugin in this handler is no longer preventative.</p>
<h5>Params</h5>
<ul>
<li><a name="handle_response_decision.request"><code>request</code></a>: own&lt;<a href="#incoming_request"><a href="#incoming_request"><code>incoming-request</code></a></a>&gt;</li>
<li><a name="handle_response_decision.response"><code>response</code></a>: own&lt;<a href="#incoming_response"><a href="#incoming_response"><code>incoming-response</code></a></a>&gt;</li>
<li><a name="handle_response_decision.params"><code>params</code></a>: list&lt;<a href="#param"><a href="#param"><code>param</code></a></a>&gt;</li>
</ul>
<h5>Return values</h5>
<ul>
<li><a name="handle_response_decision.0"></a> result&lt;<a href="#handler_output"><a href="#handler_output"><code>handler-output</code></a></a>, <a href="#error"><a href="#error"><code>error</code></a></a>&gt;</li>
</ul>
<h4><a name="handle_decision_feedback"><code>handle-decision-feedback: func</code></a></h4>
<p>Called after all plugins have rendered their decisions and the results combined.</p>
<p>This handler may be used to create feedback loops, train models, or to make API calls
...
response handler rather than the request handler.</p>
<h5>Params</h5>
<ul>
<li><a name="handle_decision_feedback.request"><code>request</code></a>: own&lt;<a href="#incoming_request"><a href="#incoming_request"><code>incoming-request</code></a></a>&gt;</li>
<li><a name="handle_decision_feedback.response"><code>response</code></a>: own&lt;<a href="#incoming_response"><a href="#incoming_response"><code>incoming-response</code></a></a>&gt;</li>
<li><a name="handle_decision_feedback.params"><code>params</code></a>: list&lt;<a href="#param"><a href="#param"><code>param</code></a></a>&gt;</li>
<li><a name="handle_decision_feedback.verdict"><a href="#verdict"><code>verdict</code></a></a>: <a href="#verdict"><a href="#verdict"><code>verdict</code></a></a></li>
</ul>
<h5>Return values</h5>
<ul>
<li><a name="handle_decision_feedback.0"></a> result&lt;_, <a href="#error"><a href="#error"><code>error</code></a></a>&gt;</li>
</ul>
